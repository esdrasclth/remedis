    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          id={id}
          className={cn(
            "bg-input-bg rounded-[8px] px-3 py-2 text-[13px] text-pure-white placeholder:text-iron-gray focus:outline-none focus:bg-input-focus transition-colors resize-none",
